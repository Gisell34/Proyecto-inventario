...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 13-06-2024 a las 22:48:43
...
(14, 'coca cola', 'coca cola', 'bebida gacificada', 0);
...
INSERT INTO `servicios` (`Codigo`, `Nombre_servicio`, `Tipo_servicio`) VALUES
(1, 'Comida rapida', 'servicio de comida');
...
--
ALTER TABLE `producto`
  MODIFY `Codigoproducto` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=15;
...
--
ALTER TABLE `inventario`
  ADD CONSTRAINT `fk_inventario_producto` FOREIGN KEY (`Codigoproducto`) REFERENCES `producto` (`Codigoproducto`);
COMMIT;
