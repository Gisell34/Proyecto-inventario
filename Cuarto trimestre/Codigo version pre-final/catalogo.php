...
<body>
    <div class="catalogo-container">
        ...
        <h3>Servicios</h3>
        <table class="catalogo-table catalogo-servicios">
            <thead>
                <tr>
                    <th>Código</th>
    ...
    <div class="mensaje-flotante" data-conteo="<?= count($carrito) + count($servicios) ?>">
        Productos en el carrito: <?= count($carrito) ?> productos y <?= count($servicios) ?> servicios
    </div>
</body>
</html>