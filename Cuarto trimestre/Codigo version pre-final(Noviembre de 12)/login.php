...
if (isset($_POST['submit'])) {
    ...
    if (preg_match("/^[a-zA-Z0-9]+$/", $usuario) && preg_match("/^[a-zA-Z]+$/", $rol)) {
        ...
        echo "<script>alert('El usuario o rol contienen caracteres inválidos'); window.history.back();</script>";
    }
}
?>
<!DOCTYPE html>
...
<body>
    <form id="loginForm" name="loginForm" action="login.php" method="POST" onsubmit="return validarFormulario()">
