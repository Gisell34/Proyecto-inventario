...
<body>
    ...
    <div class="admin-panel">
        ...
        <form id="producto_form" action="guardar_producto.php" method="POST">
            ...
            <div id="form_data">
                ...
                <!-- Solo el botón de Guardar Producto -->
            ...
            <div id="register_form">
                ...
                <label for="cantidad_registro">Cantidad a agregar:</label>
                <input type="number" id="cantidad_registro" name="cantidad_registro" required><br><br>
