...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (array_key_exists($codigoProducto, $_SESSION['carrito'])) {
        ...
        $_SESSION['carrito'][$codigoProducto] = array(
            'nombre' => '', // Será establecido después en la consulta
            'cantidad' => $cantidad,
            'precio' => 0, // Será establecido después en la consulta
            'tipo' => 'producto'
        );
    }

    // Obtener los datos del producto para completar la información en el carrito
