...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 19-09-2024 a las 19:27:57
...
(1, 35, 3100, 34, 1, 0, 5, 39, 4030.00, 930),
(2, 75, 2500, 75, 0, 0, 9, 83, 3250.00, 750),
(3, 11, 3380, 9, 2, 11, 2, 13, 4394.00, 1014),
(6, 35, 3380, 35, 0, 35, 5, 39, 4160.00, 780),
(8, 25, 2600, 23, 2, 25, 3, 28, 3380.00, 780),
(9, 40, 3400, 39, 1, 40, 8, 12, 4420.00, 1020),
(10, 100, 230000, 0, 0, 100, 0, 0, 230000.00, 0),
(11, 70, 32000, 70, 0, 70, 10, 7, 32000.00, 9600);
...
--
ALTER TABLE `compras`
  MODIFY `id_compra` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=192;
...
--
ALTER TABLE `producto`
  MODIFY `Codigoproducto` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;
